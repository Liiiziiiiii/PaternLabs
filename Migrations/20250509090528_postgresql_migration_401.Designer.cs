...
namespace PaternLab.Migrations
{
    ...
    [Migration("20250509090528_postgresql_migration_401")]
    partial class postgresql_migration_401
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PaternLab.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PaternLab.Models.Doctor", b =>
                {
                    b.HasBaseType("PaternLab.Models.Person");
            ...
            modelBuilder.Entity("PaternLab.Models.Doctor", b =>
                {
                    ...
                    b.HasOne("PaternLab.Models.Person", null)
                        .WithOne()
                        .HasForeignKey("PaternLab.Models.Doctor", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("PaternLab.Models.Patient", b =>
                {
                    b.HasOne("PaternLab.Models.Person", null)
                        .WithOne()
                        .HasForeignKey("PaternLab.Models.Patient", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
